...
def train2():
    ...
    vae = VAE(
        ...
        conditional=True,
        num_labels=10 if True else 0).to(device)
    ...
    for epoch in range(10):
        ...
        for iteration, (x, y) in enumerate(data_loader):
            ...
            y = int(sm.argmax(axis=0))
            
            recon_x, mean, log_var, z = vae(x, Variable(torch.tensor([[y]]))
        ...
        g.savefig(os.path.join(
            ...
            dpi=300)
    torch.save(vae, os.path.join('figs', 'modelvaes.pth'))
